...
/**
 * Call-to-action section replacing the contact form.
 * Three actions: TestFlight beta, build from source, report an issue.
 */
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>
            Join the public TestFlight beta to try SpoolKid, or build it yourself
            from source. Found a bug? Open an issue on GitHub.
          </p>
          ...
          <div className={styles.actions}>
            ...
            {/* Report an issue */}
            <motion.a
              href="https://github.com/SnapMakerU1/SpoolKid/issues/new"
              className={styles.secondary}
              target="_blank"
              rel="noopener noreferrer"
              whileHover={reduced ? undefined : { scale: 1.03 }}
